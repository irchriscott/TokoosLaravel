<div class="header">
    <div class="pull-left">
        <div class="logo"><a href="index.html"><!-- <img src="assets/images/logo.png" alt="" /> --><span>Admin :: Tokoos Ride</span></a></div>
    ...
    <div class="pull-right p-r-15">
        <ul>
            ...
            <li class="header-icon dib"><img class="avatar-img" src="{{ asset('backend/images/avatar/1.jpg') }}" alt="" /> <span class="user-avatar">{{ Auth::user()->full_name }} <i class="ti-angle-down f-s-10"></i></span>
